...
from SocketIOTunnel.crypto import common
...
id_to_method.extend(rc4_md5.ciphers.keys())
id_to_method.extend(sodium.ciphers.keys())
id_to_method.sort()
method_to_id = OrderedDict()
for i in range(len(id_to_method)):
    method_to_id[id_to_method[i]] = i
